...
public class MovieListAdapter extends ListAdapter<MovieUi, MovieListAdapter.MovieViewHolder> {
    ...
    class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(MovieUi movie) {
            ...
            binding.movieDate.setText(movie.getReleaseDate() != null ? movie.getReleaseDate() : "N/A");
            ...
            if (movie.isFavorite()) {
                ...
                binding.favoriteIcon.setImageDrawable(ContextCompat.getDrawable(binding.getRoot().getContext(), R.drawable.ic_favorite_unselected));
            }
